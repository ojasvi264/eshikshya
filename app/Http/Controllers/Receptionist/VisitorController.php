...
class VisitorController extends Controller
{
    ...
    public function visitorStore(StoreVisitorRequest $request)
    {
        ...
        $visitor->save();
        return redirect()->route('receptionist.visitor-book')->with('success', 'Created successfully');
    ...
    public function visitorUpdate(UpdateVisitorRequest $request)
    {
        ...
        $visitor->update();
        return redirect()->route('receptionist.visitor-book')->with('success', 'Updated successfully.');
    }
    /**
    ...
    public function visitorDestroy(Visitor $visitor, $id)
    {
        $visitor = Visitor::findOrFail($id);
        $visitor ->delete();
        return redirect()->route('receptionist.visitor-book')->with('success', 'Deleted successfully');
    }
    /**
