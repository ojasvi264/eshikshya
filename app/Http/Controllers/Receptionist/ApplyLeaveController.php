...
class ApplyLeaveController extends Controller
{
    ...
    public function index()
    {
        ...
        $applyLeaves = ApplyLeave::latest()->get();
    ...
    public function store(StoreApplyLeaveRequest $request)
    {
        ...
        return redirect()->route('receptionist.apply_leave.index')->with('success', 'Created successfully');
    }
    ...
    {
        $applyLeaves = ApplyLeave::whereNotIn('id', [$applyLeave->id])->get();
        $leaveTypes = LeaveType::latest()->get();
    ...
    public function update(StoreApplyLeaveRequest $request, ApplyLeave $applyLeave)
    {
        ...
        return redirect()->route('receptionist.apply_leave.index')->with('success', 'Updated successfully');
    }
