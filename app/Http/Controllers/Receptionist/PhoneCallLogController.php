...
class PhoneCallLogController extends Controller
{
    ...
    public function phoneCallLogStore(StorePhoneCallLogRequest $request)
    {
        ...
        $phoneCallLog->save();
        return redirect()->route('receptionist.phone-call-log')->with('success', 'Created successfully');
    }
    /**
    ...
    public function phoneCallLogUpdate(UpdatePhoneCallLogRequest $request)
    {
        ...
        $phoneCallLog->call_type= $request->call_type;
        $phoneCallLog->update();
        return redirect()->route('receptionist.phone-call-log')->with('success', 'Updated successfully');
    }
    ...
    public function phoneCallLogDestroy($id)
    {
        ...
        $phoneCallLog->delete();
        return redirect()->route('receptionist.phone-call-log')->with('success', 'Deleted successfully');
    }
    /**
