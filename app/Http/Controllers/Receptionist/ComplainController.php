...
class ComplainController extends Controller
{
    ...
    public function complainStore(StoreComplainRequest $request)
    {
        ...
        $complain->save();
        return redirect()->route('receptionist.complain')->with('success', 'Created successfully');
    }
    /**
    ...
    public function complainUpdate(UpdateComplainRequest $request)
    {
        ...
        $complain->update();
        return redirect()->route('receptionist.complain')->with('success', 'Updated successfully');
    }
    /**
    ...
    public function complainDestroy(Complain $complain, $id)
    {
        ...
        $complain->delete();
        return redirect()->route('receptionist.complain')->with('success', 'Deleted successfully');
    }
    /**
