...
namespace App\Http\Controllers\LessonPlans;
...
class LessonController extends Controller
{
    ...
    public function store(StoreLessonRequest $request)
    {
        ...
        return redirect()->route('lesson.index')->with('success', 'Created successfully');
    ...
    public function update(StoreLessonRequest $request, Lesson $lesson)
    {
        ...
        return redirect()->route('lesson.index')->with('success', 'Updated successfully');
    }
