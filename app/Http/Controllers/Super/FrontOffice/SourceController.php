...
class SourceController extends Controller
{
    ...
    public function sourceStore(StoreSourceRequest $request)
    {
        ...
        $source->save();
        return redirect()->route('source')->with('success', 'Created successfully');
    }
    /**
    ...
    public function sourceUpdate(UpdateSourceRequest $request)
    {
        ...
        if ($source === null) {
            ...
            $source->description = $request->description;
            $source->update();
            return redirect()->route('source')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('source')->with('error', 'Data already exists.');
        }
    }
    /**
    ...
    public function sourceDestroy($id)
    {
        ...
        $source->delete();
        return redirect()->route('source')->with('success', 'Deleted successfully');
    }
