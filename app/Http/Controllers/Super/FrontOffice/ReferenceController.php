...
class ReferenceController extends Controller
{
    ...
    public function referenceStore(StoreReferenceRequest $request)
    {
        ...
        $reference->save();
        return redirect()->route('reference')->with('success', 'Created successfully');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function referenceUpdate(UpdateReferenceRequest $request)
    {
        ...
        if($reference === null){
            ...
            $reference->description = $request->description;
            $reference->update();
            return redirect()->route('reference')->with('success', 'Updated successfully');
        }
        else {
            return redirect()->route('reference')->with('error', 'Data already exists.');
        }
    }
    ...
    public function referenceDestroy($id)
    {
        $reference = Reference::find($id);
        $reference->delete();
        return redirect()->route('reference')->with('success', 'Deleted successfully');
    }
