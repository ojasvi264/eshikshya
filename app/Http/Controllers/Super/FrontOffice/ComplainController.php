...
class ComplainController extends Controller
{
    ...
    public function complainStore(StoreComplainRequest $request)
    {
        ...
        if ($request->hasFile('file')) {
            foreach ($request->file('file') as $image) {
                ...
                $image->move(public_path('files/complain'), $filename);
                $fileNames[] = $filename;
            }
        }
    ...
    public function complainUpdate(UpdateComplainRequest $request)
    {
        ...
        $complain->file=json_encode($fileNames);
        $complain->update();
        return redirect()->route('complain')->with('success', 'Updated successfully');
    }
    /**
    ...
    public function complainDestroy(Complain $complain, $id)
    {
        ...
        $complain->delete();
        return redirect()->route('complain')->with('success', 'Deleted successfully');
    }
    /**
