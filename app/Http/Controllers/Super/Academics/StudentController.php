...
class StudentController extends Controller
{
    ...
    {
        return view('superadmin.academics.student.index');
    }
    ...
    public function studentStore(StoreStudentRequest $request)
    {
        ...
        if ($student === null) {
            ...
            return redirect()->route('student')->with('success', 'Created successfully');
        } else {
            return redirect()->route('student')->with('error', 'Data already exists.');
        }
    }
    ...
    public function studentUpdate(UpdateStudentRequest $request, Student $student)
    {
        ...
        return redirect()->route('student')->with('success', 'Updated successfully');
    ...
    public function studentdetails(Request $request)
    {
        ...
        return view ('superadmin.student_information.studentDetails.view',['class' => $class, 'section' => $section],compact('students'));
    }
    ...
    {
        $students = Student::all();
        return view ('superadmin.student_information.bulkDelete.delete',compact('students'));
    }

    public function collectfee(Request $request)
    {
        $students = Student::all();
        return view ('dashboard.pages.studentdetails',compact('students'));
    }

    public function createcategory()
    {
        return view('dashboard.pages.studentinfocategory');
    }
}
