...
class LeaveRequestController extends Controller
{
    ...
    public function store(StoreLeaveRequestRequest $request)
    {
        ...
        return redirect()->route('admin.leave_request.index')->with('success', 'Created successfully');
    }
    ...
    public function update(StoreLeaveRequestRequest $request, LeaveRequest $leaveRequest)
    {
        ...
        return redirect()->route('admin.leave_request.index')->with('success', 'Updated successfully');
    }
