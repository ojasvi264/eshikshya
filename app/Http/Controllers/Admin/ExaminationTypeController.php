...
class ExaminationTypeController extends Controller
{
    ...
    public function examinationStore(StoreExaminationTypeRequest $request)
    {
        ...
        if ($examinationType === null) {
            ...
            return redirect()->route('admin.exam-type')->with('success', 'Created successfully');
        }
        else{
            return redirect()->route('admin.exam-type')->with('error', 'Data already exists.');
        }
    }
    /**
    ...
    public function examinationUpdate(UpdateExaminationTypeRequest $request)
    {
        ...
        if ($examinationType === null) {
            ...
            return redirect()->route('admin.exam-type')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('admin.exam-type')->with('error', 'Data already exists.');
        }
    ...
    public function examinationDestroy($id)
    {
        ...
        return redirect()->route('admin.exam-type')->with('success', 'Deleted successfully');
    }
    /**
