...
class LeaveTypeController extends Controller
{
    ...
    public function store(StoreLeaveTypeRequest $request)
    {
        ...
        return redirect()->route('admin.leave_type.index')->with('success', 'Created Successfully.');
    }
    ...
    public function update(StoreLeaveTypeRequest $request, LeaveType $leaveType)
    {
        ...
        return redirect()->route('admin.leave_type.index')->with('success', 'Updated Successfully.');
    }
