...
class PostalReceiveController extends Controller
{
    ...
    public function postalReceiveStore(StorePostalReceiveRequest $request)
    {
        ...
        $postalReceive->save();
        return redirect()->route('admin.postal-receive')->with('success', 'Created successfully');
    }
    ...
    public function postalReceiveUpdate(UpdatePostalReceiveRequest $request)
    {
        ...
        return redirect()->route('admin.postal-receive')->with('success', 'Updated successfully');
    }
    ...
    public function postalReceiveDestroy($id)
    {
        ...
        return redirect()->route('admin.postal-receive')->with('success', 'Deleted successfully');
    }
    /**
