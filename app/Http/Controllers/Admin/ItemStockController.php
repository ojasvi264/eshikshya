...
class ItemStockController extends Controller
{
    ...
    public function store(StoreItemStockRequest $request)
    {
        ...
        return redirect()->route('admin.item_stock.index')->with('success', 'Created successfully');    }
    ...
    public function update(StoreItemStockRequest $request, ItemStock $itemStock)
    {
        ...
        return redirect()->route('admin.item_stock.index')->with('success', 'Updated successfully');
    }
