...
class ItemCategoryController extends Controller
{
    ...
    public function store(StoreItemCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.item_category.index')->with('success', 'Created Successfully.');
    }
    ...
    public function update(StoreItemCategoryRequest $request, ItemCategory $itemCategory)
    {
        ...
        return redirect()->route('admin.item_category.index')->with('success', 'Updated Successfully.');
    }
