...
class ClassScheduleController extends Controller
{
    ...
    public function scheduleStore(StoreClassScheduleRequest $request)
    {
        ...
        if($classSchedule === null){
            ...
            $classSchedule->save();
            return redirect()->route('admin.class-schedule')->with('success', 'Created successfully');
        }
        else{
            return redirect()->route('admin.class-schedule')->with('error', 'Data already exists.');
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function scheduleUpdate(UpdateClassScheduleRequest $request, $id)
    {
        ...
        if ($classSchedule === null) {
            ...
            return redirect()->route('admin.class-schedule')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('admin.class-schedule')->with('error', 'Data already exists.');
        }
