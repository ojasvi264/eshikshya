...
use App\Http\Requests\StoreItemSupplier;
...
class ItemSupplierController extends Controller
{
    ...
    public function store(StoreItemSupplierRequest $request)
    {
        ...
        return redirect()->route('item_supplier.index')->with('success', 'Created Successfully.');
    }
    ...
    public function update(StoreItemSupplierRequest $request, ItemSupplier $itemSupplier)
    {
        ...
        return redirect()->route('item_supplier.index')->with('success', 'Updated Successfully.');
    }
