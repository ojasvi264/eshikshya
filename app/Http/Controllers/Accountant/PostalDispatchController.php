...
class PostalDispatchController extends Controller
{
    ...
    public function store(StorePostalDispatchRequest $request)
    {
        ...
        $postalDispatch->save();
        return redirect()->route('accountant.postal-dispatch')->with('success', 'Created successfully');
    }
    ...
    public function update(UpdatePostalDispatchRequest $request)
    {
        ...
        return redirect()->route('accountant.postal-dispatch')->with('success', 'Updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('accountant.postal-dispatch')->with('success', 'Deleted successfully');
    }
}
