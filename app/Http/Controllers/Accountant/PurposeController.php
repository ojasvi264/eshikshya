...
class PurposeController extends Controller
{
    ...
    {$purpose = Purpose::where('purpose', '=', $request->purpose)
        ...
        if ($purpose === null) {
            ...
            $purpose->save();
            return redirect()->route('accountant.purpose')->with('success', 'Created successfully');
        }
        else{
            return redirect()->route('accountant.purpose')->with('error', 'Data already exists.');
        }
    }
    /**
    ...
    public function purposeUpdate(UpdatePurposeRequest $request)
    {
        ...
        if ($purpose === null) {
            ...
            $purpose->description = $request->description;
            $purpose->update();
            return redirect()->route('accountant.purpose')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('accountant.purpose')->with('error', 'Data already exists.');
        }
    ...
    public function purposeDestroy(Purpose $purpose,$id)
    {
        ...
        $purpose ->delete();
        return redirect()->route('accountant.purpose')->with('success', 'Deleted successfully');
    }
    /**
