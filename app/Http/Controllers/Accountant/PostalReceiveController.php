...
class PostalReceiveController extends Controller
{
    ...
    public function postalReceiveStore(StorePostalReceiveRequest $request)
    {
        ...
        $postalReceive->save();
        return redirect()->route('accountant.postal-receive')->with('success', 'Created successfully');
    }
    ...
    public function postalReceiveUpdate(UpdatePostalReceiveRequest $request)
    {
        ...
        return redirect()->route('accountant.postal-receive')->with('success', 'Updated successfully');
    }
    ...
    public function postalReceiveDestroy($id)
    {
        ...
        return redirect()->route('accountant.postal-receive')->with('success', 'Deleted successfully');
    }
    /**
