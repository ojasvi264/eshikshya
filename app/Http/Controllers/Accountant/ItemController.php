...
class ItemController extends Controller
{
    ...
    public function store(StoreItemRequest $request)
    {
        ...
        return redirect()->route('accountant.item.index')->with('success', 'Created successfully');
    }
    ...
    public function update(StoreItemRequest $request, Item $item)
    {
        ...
        return redirect()->route('accountant.item.index')->with('success', 'Updated successfully');
    }
