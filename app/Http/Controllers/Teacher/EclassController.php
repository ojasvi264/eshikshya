...
class EclassController extends Controller
{
    ...
    public function classUpdate(UpdateEclassRequest $request)
    {
        ...
        if($eclass === null){
            ...
            $eclass->update();
            return redirect()->route('teacher..class')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('teacher..class')->with('error', 'Data already exists.');
        }
    ...
    public function classDestroy(Eclass $eclass, $id)
    {
        $eclass = Eclass::findOrFail($id);
        $eclass->delete();
        return redirect()->route('teacher..class')->with('success', 'Deleted successfully');
    }
