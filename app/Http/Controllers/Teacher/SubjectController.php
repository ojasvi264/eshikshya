...
class SubjectController extends Controller
{
    ...
    public function subjectStore(StoreSubjectRequest $request)
    {
        ...
        if ($subject === null) {
            ...
            $subject->save();
            return redirect()->route('teacher.subject')->with('success', 'Created successfully');
        }
        else{
            return redirect()->route('teacher.subject')->with('error', 'Data already exists.');
        }
    ...
    public function subjectUpdate(UpdateSubjectRequest $request)
    {
        ...
        $subject->section_id = $request->section_id;
        $subject->update();
        return redirect()->route('teacher.subject')->with('success', 'Updated successfully');
    }
    ...
    public function subjectDestroy(Subject $subject, $id)
    {
        ...
        $subject ->delete();
        return redirect()->route('teacher.subject')->with('success', 'Deleted successfully');
    }
    /**
