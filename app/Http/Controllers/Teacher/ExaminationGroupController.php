...
class ExaminationGroupController extends Controller
{
    ...
    public function examinationStore(StoreExaminationGroupRequest $request)
    {
        ...
        if ($examinationGroup === null) {
            ...
            return redirect()->route('teacher.exam-group')->with('success', 'Created successfully');
        }
        else{
            return redirect()->route('teacher.exam-group')->with('error', 'Data already exists.');
        }
    }
    /**
    ...
    public function examinationGroupUpdate(UpdateExaminationGroupRequest $request)
    {
        ...
        if ($examinationGroup === null) {
            ...
            return redirect()->route('teacher.exam-group')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('teacher.exam-group')->with('error', 'Data already exists.');
        }
    ...
    public function examinationGroupDestroy($id)
    {
        ...
        return redirect()->route('teacher.exam-group')->with('success', 'Deleted successfully');
    }
