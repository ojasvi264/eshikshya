...
class SessionClassController extends Controller
{
    ...
    public function update(UpdateSessionClassRequest $request)
    {
        ...
        $sessionClass->section_id = $request->section_id;
        $sessionClass->update();
        return redirect()->route('teacher.session-class')->with('success', 'Updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $sectionClass ->delete();
        return redirect()->route('teacher.session-class')->with('success', 'Deleted successfully');
    }
}
