...
class FeedController extends Controller
{
    ...
    public function feedStore(StoreFeedRequest $request)
    {
        ...
        $feed->save();
        return redirect()->route('teacher.feed')->with('success', 'Created successfully');
    }
    ...
    public function feedUpdate(UpdateFeedRequest $request)
    {
        ...
        $feed->update();
        return redirect()->route('teacher.feed')->with('success', 'Updated successfully');
    }
    /**
    ...
    public function feedDestroy(Feed  $feed, $id)
    {
        ...
        $feed->delete();
        return redirect()->route('teacher.feed')->with('success', 'Deleted successfully');
