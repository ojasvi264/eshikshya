...
class SectionController extends Controller
{
    ...
    public function sectionUpdate(UpdateSectionRequest $request)
    {
        ...
        if ($section === null) {
            ...
            $section ->eclasses_id = $request->eclasses_id;
            $section ->update();
            return redirect()->route('teacher.section')->with('success', 'Updated successfully');
        }
        else{
            return redirect()->route('teacher.section')->with('error', 'Data already exists.');
        }
    }
    ...
    public function sectionDestroy(Section $section, $id)
    {
        ...
        $section ->delete();
        return redirect()->route('teacher.section')->with('success', 'Deleted successfully');
    }
    /**
