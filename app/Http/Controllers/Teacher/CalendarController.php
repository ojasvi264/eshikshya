...
class CalendarController extends Controller
{
    ...
    public function calendarStore(StoreCalendarRequest $request)
    {
        ...
        $calendar->save();
        return redirect()->route('teacher.academic-calendar')->with('success', 'Created successfully');
    ...
    public function calendarUpdate(UpdateCalendarRequest $request)
    {
        ...
        $calendar ->update();
        return redirect()->route('teacher.academic-calendar')->with('success', 'Updated successfully');
    }
    /**
    ...
    public function calendarDestroy(Calendar  $calendar, $id)
    {
        ...
        $calendar ->delete();
        return redirect()->route('teacher.academic-calendar')->with('success', 'Deleted successfully');
    }
