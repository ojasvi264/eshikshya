                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Add Complain</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="text" class="form-control" name="complain_by" value='{{ old('complain_by') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="date" class="form-control" name="complain_date" value='{{ old('complain_date', Carbon\Carbon::today()->format('Y-m-d')) }}'>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="assigned" value='{{ old('assigned') }}' placeholder="Assigned to">
                                                    ...
                                                    <td>
                                                        @foreach(json_decode($item->file, true) as $key => $media_gallery)
                                                            <a href="{{ url('/files/complain/'.$media_gallery) }}" data-toggle="lightbox" data-title="Package Media Gallery" data-gallery="gallery">
                                                                <img src="{{ url('/files/complain/'.$media_gallery) }}" class="img-fluid mb-2" alt="white sample" width="50" height="50">
                                                            </a>
                                                        @endforeach
                                                    </td>
                                                    <td>
