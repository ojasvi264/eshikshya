                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit Postal Dispatch</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="
                                @if(\Illuminate\Support\Facades\Auth::guard('staff')->check())
                                    @if(auth()->guard('staff')->user()->role->name == 'Admin')
                                        {{route('admin.postal-dispatch.update')}}
                                    @elseif(auth()->guard('staff')->user()->role->name == 'Receptionist')
                                        {{route('receptionist.postal-dispatch.update')}}
                                    @elseif(auth()->guard('staff')->user()->role->name == 'Accountant')
                                        {{route('accountant.postal-dispatch.update')}}
                                    @endif
                                @elseif(\Illuminate\Support\Facades\Auth::user()->user_type == 'superadmin')
                                    {{route('postal-dispatch.update')}}
                                @endif
                                " method="POST"  enctype="multipart/form-data">
                                <input type="hidden" name='id' value={{$postalDispatch['id']}}>
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="to_title"  value="{{$postalDispatch->to_title}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="reference_no"  value="{{$postalDispatch->reference_no}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="address" value="{{$postalDispatch->address}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="from_title"  value="{{$postalDispatch->from_title}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="date"  value="{{$postalDispatch->date}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="file" name="file[]" multiple="" class="dropify">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Note</label>
                                            <textarea class="form-control" name="note">{{$postalDispatch->note}}</textarea>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example3" class="display" style="min-width: 750px">
                                            ...
                                            <tbody>
                                            @foreach($postDispatch as $key =>$item)
                                                <tr>
                                                    <td>{{$item->to_title}}</td>
