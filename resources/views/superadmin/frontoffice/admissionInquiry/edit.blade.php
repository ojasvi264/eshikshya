                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="text" class="form-control" name="phone" value="{{$admissionInquiry->phone}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email" value="{{$admissionInquiry->email}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="inquiry_date" value="{{$admissionInquiry->inquiry_date}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="follow_up" value="{{$admissionInquiry->follow_up}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="teacher_id">
                                                ...
                                                @foreach ($teacher as $data)
                                                    <option value='{{ $data->id }}' {{ (collect($admissionInquiry->teacher_id)->contains($data->id)) ? 'selected':'' }}>{{$data->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="class_id">
                                                ...
                                                @foreach ($class as $data)
                                                    <option value='{{ $data->id }}' {{ (collect($admissionInquiry->class_id)->contains($data->id)) ? 'selected':'' }}>{{$data->name}}</option>
                                                @endforeach
                                            </select>
