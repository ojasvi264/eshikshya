                            ...
                            <form action="
                                @if(\Illuminate\Support\Facades\Auth::guard('staff')->check())
                                    @if(auth()->guard('staff')->user()->role->name == 'Admin')
                                        {{ route('admin.class.update')}}
                                    @elseif(auth()->guard('staff')->user()->role->name == 'Teacher')
                                        {{ route('teacher.class.update')}}
                                    @endif
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{($eclass->name)}}" >
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" >{{$eclass->description}}</textarea>
