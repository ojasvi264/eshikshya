                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" value='{{old('title')}}' placeholder="Enter title for the event">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="date" class="form-control" name="event" value='{{old('event', Carbon\Carbon::today()->format('Y-m-d'))}}'>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group lst increment">
