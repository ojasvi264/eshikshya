            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Edit Notice</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('notice.update')}}" method="POST" id="sectionform">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="class_id" id="class_id">
                                                ...
                                                @foreach ($class as $data)
                                                    <option value='{{ $data->id }}' {{ (collect($notice->class_id)->contains($data->id)) ? 'selected':'' }}  >{{$data->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="notice" value="{{$notice->notice}}">
                                        ...
                                        <table id="example3" class="display" style="min-width: 845px">
                                            ...
                                            @foreach($not as $key =>$data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <a href="{{route('notice.edit',$notice['id']) }}" class='btn btn-sm btn-primary m-1'>
