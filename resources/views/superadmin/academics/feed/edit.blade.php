                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit Feed</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="
                                @if(\Illuminate\Support\Facades\Auth::guard('staff')->check())
                                    @if(auth()->guard('staff')->user()->role->name == 'Admin')
                                        {{route('admin.feed.update')}}
                                    @elseif(auth()->guard('staff')->user()->role->name == 'Teacher')
                                        {{route('teacher.feed.update')}}
                                    @endif
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="feed" value="{{$feed->feed}}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="datetime" class="form-control" name="feed_date" value="{{ $feed->feed_date }}">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="feed_content">{{ $feed->feed_content }}</textarea>
