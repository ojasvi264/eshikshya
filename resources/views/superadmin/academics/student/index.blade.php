                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="fname" placeholder="UserName"  value='{{ old('fname') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="profile_image" type="file" class="dropify" data-height="100" accept="image/*"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category_id" id="category_id">
                                                ...
                                                @foreach ($category as $data)
                                                    <option value="{{ $data->id }}" {{ (collect(old('category_id'))->contains($data->id)) ? 'selected':'' }}  >{{$data->category_name}}</option>--}}
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger">@error('section_id') {{ $message }}
                                                @enderror</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="admission" value='{{ old('admission') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="date form-control" name="dob" value='{{ old('dob', Carbon\Carbon::today()->format('Y-m-d')) }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="fathercontact"  value='{{ old('fathercontact') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mothercontact"  value='{{ old('mothercontact') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guardname"  value='{{ old('guardname') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guardemail"  placeholder="Email"  value='{{ old('guardemail') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guardrelation"  value='{{ old('guardrelation') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guardjob"  value='{{ old('guardjob') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guardcontact"  value='{{ old('guardcontact') }}'>
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="guardaddress"  value='{{ old('guardaddress') }}'>
