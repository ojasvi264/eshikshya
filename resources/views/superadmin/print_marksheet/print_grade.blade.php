                    ...
                    <div class="first-term">
                            ...
                            @foreach($marks as $mark)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            @php
                                                $theory = $mark->theory_mark  / $mark->subject->theory_full_marks * 100;
                                                $grade = getGrade($theory, $grades);
                                                echo  '<b class="thery"style="">'.$grade['name'].'</b>';
                                                $practical = $mark->practical_mark  / $mark->subject->practical_full_marks * 100;
                                    ...
                                    <td>
                                        @if($mark->subject->type == 'is_theory')
                                            @php
                                                $marks_obtained = $mark->theory_mark / $mark->subject->theory_full_marks * 100;
                                                 $grade = getGrade($marks_obtained, $grades);
                        ...
                        <table class="table-four">
                            ...
                            @foreach($grades as $row)
                                <tr>
                                    <td style="text-align: left;"><?php echo $row['per_from'] ?>% to <?php echo $row['per_to'] ?>%</td>
