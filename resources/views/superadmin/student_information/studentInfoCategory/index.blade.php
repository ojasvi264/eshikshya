            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include('dashboard.flash-message')
                            <form action="{{ route('studentinfocategory/add') }}" method="POST">
                                @csrf
                                <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example3" class="display" style="min-width: 750px">
                                            ...
                                            <tbody>
                                            @foreach($studentinfocategory as $key =>$item)
                                                <tr>
                                                    <td>{{$item->name}}</td>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <form method="post" action="{{route('studentinfocategory.destroy',$item->id)}}">
                                                                @method('delete')
                                                                @csrf
