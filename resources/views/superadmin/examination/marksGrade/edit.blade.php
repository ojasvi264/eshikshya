                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit Marks Grade</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="
                                @if(\Illuminate\Support\Facades\Auth::guard('staff')->check())
                                    @if(auth()->guard('staff')->user()->role->name == 'Admin')
                                        {{ route('admin.grade.update') }}
                                    @elseif(auth()->guard('staff')->user()->role->name == 'Teacher')
                                        {{ route('teacher.grade.update') }}
                                    @endif
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="examType_id" >
                                                ...
                                                @foreach ($types as $row)
                                                    <option value='{{ $row->id }}' {{ (collect($grade->examType_id)->contains($row->id)) ? 'selected':'' }}>{{$row->exam_type}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="text" class="form-control" name="grade_name" value="{{$grade->grade_name}}" placeholder="Enter Grade Name">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="text" class="form-control" name="percent_upto" value="{{$grade->percent_upto}}" placeholder="Enter highest percentage limit for this grade">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="text" class="form-control" name="percent_from" value="{{$grade->percent_from}}" placeholder="Enter lowest percentage limit for this grade">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span style="color: red">&#42;</span>
                                            <input type="text" class="form-control" name="grade_point" value="{{$grade->grade_point}}" placeholder="Enter grade point for this grade">
