...
<?php
	...
	$curl = curl_init();
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://actm.prabhumanagement.com/api/ChartOfAccount/GetSubsidiaryListByFlag?Flag=INLI',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
<div class="content-body">
	...
	<div class="container-fluid">
		<form action="{{route('account.voucherentry.savereceiptvoucher')}}" method="POST">
			@csrf
			<div class="row">
				<div class="col-sm-12">
					<div class="box box-primary">
						<div class="box-header ptbnull with-border">
							<h4 class="box-title titlefix" style="display: inline-block;" id="headtitle">Income Voucher</h4>
						</div><!-- /.box-header -->
						<div class="box-body">
