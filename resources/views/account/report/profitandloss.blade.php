            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box-header ptbnull with-border">
                        <h4 class="box-title titlefix" style="display: inline-block;" id="headtitle">Profit And Loss</h4>
                         </div><!-- /.box-header -->
                         <div class="box-body">
                    	...
                    	<table class="table display">
                    		...
                    		<tfoot>
                    			<tr style="border-bottom: 3px solid">
                    				<td class="summary"></td>
                    				<td colspan="2" class="text-center"><strong>Profit/Loss(रू)</strong></td>
                    				<td colspan="2" class="bg-warning"></td>
                    				<td colspan="2" class="bg-success"></td>
                    				<td class="bg-secondary text-right">
                    					@if($closingcr > $closingdr)
                    						<strong>{{$closingcr - $closingdr}}</strong>
                    					@endif
                    				</td>
                    				<td class="bg-secondary text-right">
                    					@if($closingdr > $closingcr)
                    						<strong>{{$closingdr - $closingcr}}</strong>
                    					@endif
                    				</td>
                    			</tr>
								<tr class="font-weight-bold">
									<td class="summary"></td>
									<td colspan="2" class="text-center"><strong>Grand Total(रू)</strong></td>
									<td class="bg-warning text-right">
