                        ...
                        <div class="member-name">
                            <div class="member-image">
                                @if($libraryMember->student)
                                    <img src="{{$libraryMember->student->profile_image}}" alt="">
                                @elseif($libraryMember->staff)
                                    <img src="{{$libraryMember->staff->profile_image}}" alt="">
                                @endif
                            </div>
                            <h5>
                                <strong>
                                ...
                                <div>
                                    ...
                                    <form action="
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="book_id" name="book_id">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control input-date" id="issue_date" name="issue_date"
                                                   value="old('issue_date')?old('issue_date')" style="position: relative;"/>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            var myModalEl = document.getElementById('returnBook')
