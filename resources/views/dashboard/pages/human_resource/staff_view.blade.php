            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Student Issue Return</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="member-card">
                        ...
                        <div>
                            <table class="table mx-auto w-100">
                                ...
                                <tr>
                                    <th>Role</th>
                                    <td>{{$staffDirectory->role->name}}</td>
                                </tr>
                                <tr>
                                    <th>Department</th>
                                    <td>{{$staffDirectory->department->name}}</td>
                                </tr>
                                <tr>
                                    <th>Designation</th>
                                    <td>{{$staffDirectory->designation->designation}}</td>
                                </tr>
                                <tr>
                                    <th>Phone Number</th>
                    ...
                    <div class="member-card">
                        ...
                        <div class="detail-header">
                            ...
                            <table class="table table mx-auto w-100">
                                ...
                                <tr>
                                    <th>Contract Type</th>
                                    <td>{{$staffDirectory->contract_type ?? 'N/A'}}</td>
                                </tr>
                                <tr>
                                    <th>Basic Salary</th>
